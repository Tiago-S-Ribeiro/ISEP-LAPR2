 ...
 */
public class ExportAdapterXLS implements Exporter {
    ...
    public void exportFile(List<ExecutionOrder> executionOrders, String fileName) {
        ...
        try {
            out = new FileOutputStream(fileName + "(XLS).xls");
            workbook.write(out);
            out.close();
        } catch (FileNotFoundException fnf) {
            System.out.println("It was not possible to export your execution orders file to a .XLS file.");
